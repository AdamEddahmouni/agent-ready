...
| `agent-ready explain` | proposed (ADR-0024)  | Given a diagnostic code (or the output of a previous run), print an extended, plain-language explanation and the relevant contract field. Read-only.                                                                                                          |
